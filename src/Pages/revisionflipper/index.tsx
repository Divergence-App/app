...
const AZURE_MODEL_DEPLOYMENT = 'gpt-4o'; // Updated model deployment name
...
const getPromptForStyle = (style: string): string => {
  const prompts: Prompts = {
    [LEARNING_STYLES.SUMMARIZED]:
      'Summarize these notes into key bullet points:',
    [LEARNING_STYLES.SIMPLIFIED]:
      'Simplify these notes for easier understanding:',
    [LEARNING_STYLES.IN_DEPTH]:
      'Provide an in-depth analysis and explanation of these notes:',
  };
